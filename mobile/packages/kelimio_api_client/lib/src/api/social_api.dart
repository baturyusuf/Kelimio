...
class SocialApi {
  ...
  Future<Response<Leaderboard>> getGlobalLeaderboard({
    int? limit = 20,
    ...
    final _path = r'/v1/leaderboards/global';
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<Leaderboard, Leaderboard>(
              rawData,
              'Leaderboard',
              growable: true,
            );
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [OwnPublicProfile] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OwnPublicProfile>> getOwnPublicProfile({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/me/public-profile';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
    ...
    OwnPublicProfile? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<OwnPublicProfile, OwnPublicProfile>(
              rawData,
              'OwnPublicProfile',
              growable: true,
            );
    ...
    return Response<OwnPublicProfile>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<PublicProfile>> getPublicProfile({
    ...
    final _path = r'/v1/profiles/{username}'.replaceAll(
      '{'
      r'username'
      '}',
      username.toString(),
  ...
  /// Returns a [Future] containing a [Response] with a [OwnPublicProfile] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OwnPublicProfile>> updateOwnPublicProfile({
    required UpdatePublicProfileRequest updatePublicProfileRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      _bodyData = jsonEncode(updatePublicProfileRequest);
    } catch (error, stackTrace) {
      throw DioException(
