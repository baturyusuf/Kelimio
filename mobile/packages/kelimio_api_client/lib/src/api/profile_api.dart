...
class ProfileApi {
  ...
  Future<Response<MeResponse>> completeProfileSetup({
    required String idempotencyKey,
    required ProfileSetupRequest profileSetupRequest,
    ...
    final _path = r'/v1/me/profile-setup';
    ...
    try {
      _bodyData = jsonEncode(profileSetupRequest);
