...
| iOS | deployment target 15.0; Swift Package Manager | Xcode project/shared scheme, `pubspec.lock`, and macOS CI | ADR-019 selects Flutter 3.44's default SwiftPM integration. A platform or dependency-manager change requires plugin, device reach, and product analysis plus an ADR. |
