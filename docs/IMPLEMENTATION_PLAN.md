...
Status: in progress; local/test intake, approval, deterministic Type-D composition, stored client-capability enforcement, unpublished-draft commit, impact-bound release activation/rollback services, and paged release-aware reprojection are implemented. Initial publication passes real-service E2E; production enablement, mobile authoring, subsequent-release creation, and non-empty rollback/reprojection evidence remain open.
...
- mobile teacher tree/editor, validation, drafts, ETag conflicts, diff/reapply, impact acknowledgement, and unsaved-change protection;
